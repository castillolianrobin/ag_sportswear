...
<template>
  <div class="relative">
    ...
    <div 
      class="
        relative 
        w-full h-[270px] md:h-[50vw] lg:h-[80vh] xl:h-[95vh] 
        overflow-hidden 
    ...
    >
      ...
      <div 
        class="
          ...
          absolute md:top-20 -right-20 md:right-5 
          bg-primary-100/90 dark:bg-primary-800/75  
          shadow 
          border-double border-8 border-primary-500 dark:border-primary-950 
      ...
      >
        ...
        <div class="mt-2 flex items-center justify-end">
          <div class="scale-150 mr-5">
            <ToggleDarkMode></ToggleDarkMode>
          </div>
          <h3 
            class="
              transition-colors text-secondary-800 dark:text-secondary-400 text-3xl lg:text-4xl text-right font-serif"
          >
            Frontend Developer
          </h3>
        </div>
